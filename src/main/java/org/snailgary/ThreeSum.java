    ...
    public List<List<Integer>> threeSum(int[] nums) {
        ...
        if (nums.length == 3) {
            if (nums[0] + nums[1] + nums[2] == 0) {
                zeroList.add(Arrays.asList(nums[0], nums[1], nums[2]));
                return zeroList;
            }else {
                return zeroList;
            }
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            integerListMap.put(i, listList);

        }


        integerListMap.entrySet().forEach(integerListEntry -> {
            List<List<Integer>> listList = integerListEntry.getValue();

            for (int mapListIndex = 0; mapListIndex < listList.size(); mapListIndex++) {
                List<Integer> integers = listList.get(mapListIndex);
                //System.out.println(integers);
                for (int startIndex = integerListEntry.getKey() + 1; startIndex < nums.length; startIndex++) {

                    if (integers.size() == 2) {
                        //System.out.println(startIndex + "-------" + integerListEntry.getKey());
                        if ((integers.get(0) + integers.get(1) + nums[startIndex]) == 0 && startIndex != mapListIndex + integerListEntry.getKey() + 1) {

                            integers.add(nums[startIndex]);
                            //System.out.println(integers);
                            Collections.sort(integers);
                            //zeroList.add(integers);
                            integerSet.add(integers);
                        }
    ...
    public List<List<Integer>> threeSum3(int[] num) {
        ...
        for (int i = 0; i < num.length-2; i++) {
            if (i == 0 || (i > 0 && num[i] != num[i-1])) {
                ...
                while (lo < hi) {
                    if (num[lo] + num[hi] == sum) {
                        List<Integer> integers = Arrays.asList(num[i], num[lo], num[hi]);
                        Collections.sort(integers);
...
//                        while (lo < hi && num[hi] == num[hi-1]) hi--;
    ...
    private static class ThreeSumObj {
    }
    ...
    public void resultTest() {
        ...
        System.out.println(threeSum1(new int[]{82597,
                -9243,
                62390,
                83030,
                -97960,
